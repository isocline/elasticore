//ecd:559428648H20250408175247_V1.0
...
public class Q {
	...
	public static class QxBaseEntity {
	    private final FieldInfo F_createDate=new FieldInfo<BaseEntity>("createDate",java.time.LocalDateTime.class, null);
	    ...
	    private final FieldInfo F_createdBy=new FieldInfo<BaseEntity>("createdBy",String.class, null);
	...
	public static class QxAuditEntity {
	    private final FieldInfo F_lastModifiedBy=new FieldInfo<AuditEntity>("lastModifiedBy",String.class, null);
	    ...
	    private final FieldInfo F_lastModifiedDate=new FieldInfo<AuditEntity>("lastModifiedDate",java.time.LocalDateTime.class, null);
	    ...
	    private final FieldInfo F_createIP=new FieldInfo<AuditEntity>("createIP",String.class, null);
	    ...
	    private final FieldInfo F_lastModifiedIP=new FieldInfo<AuditEntity>("lastModifiedIP",String.class, null);
	...
	public static class QxMessage {
	    private final FieldInfo F_msgId=new FieldInfo<Message>("msgId",Long.class, null);
	    ...
	    private final FieldInfo F_ccId=new FieldInfo<Message>("ccId",String.class, null);
	    ...
	    private final FieldInfo F_sender=new FieldInfo<Message>("sender",String.class, null);
	    ...
	    private final FieldInfo F_recipient=new FieldInfo<Message>("recipient",String.class, null);
	    ...
	    private final FieldInfo F_uuid=new FieldInfo<Message>("uuid",String.class, null);
	    ...
	    private final FieldInfo F_content=new FieldInfo<Message>("content",String.class, null);
	    ...
	    private final FieldInfo F_status=new FieldInfo<Message>("status",MessageStatus.class, null);
	    public final String status=F_status.getName();
	    public final FieldInfo getStatus() {return F_status;}
	    private final FieldInfo F_msgType=new FieldInfo<Message>("msgType",MessageType.class, null);
	    public final String msgType=F_msgType.getName();
	    public final FieldInfo getMsgType() {return F_msgType;}
	    private final FieldInfo F_errMsg=new FieldInfo<Message>("errMsg",String.class, null);
	    ...
	    private final FieldInfo F_recvDatetime=new FieldInfo<Message>("recvDatetime",java.time.LocalDateTime.class, null);
	    ...
	    private final FieldInfo F_recvEndDatetime=new FieldInfo<Message>("recvEndDatetime",java.time.LocalDateTime.class, null);
