//ecd:2006971991H20241223210702_V1.0
...
@NoArgsConstructor
@AllArgsConstructor
public  class BrandInfoSrchDTO  implements java.io.Serializable, SortableObject, PageableObject  {

	/*
	  브랜드명 // 예
	*/
	@Schema(description = "브랜드명 // 예 Field equals value. field:brandName" , requiredMode=Schema.RequiredMode.REQUIRED )
	@NotNull
	@NotBlank
	@Size(max=50)
