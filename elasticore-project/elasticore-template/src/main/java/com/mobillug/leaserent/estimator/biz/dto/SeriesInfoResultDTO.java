//ecd:-306600606H20241223210702_V1.0
...
@NoArgsConstructor
@AllArgsConstructor
public  class SeriesInfoResultDTO  implements java.io.Serializable  {
	...
	*/
	...
	/*
	  차종 // 예
	*/
	@Schema(description = "차종 // 예"  )
	private String type;
	
	/*
	  차량 대표 이미지 url
	*/
	@Schema(description = "차량 대표 이미지 url"  )
	@Size(max=512)
