//ecd:-1814921755H20241223210702_V1.0
...
@NoArgsConstructor
@AllArgsConstructor
public  class SeriesInfoSrchDTO  implements java.io.Serializable, SortableObject, PageableObject  {

	@Schema(description = "Field equals value. field:brandInfoId"  )
