//ecd:1286306640H20240806171759_V0.8
...
public class GateoneMapper {
    ...
    public static void mapping(LoginUser from, LoginUserDTO to, boolean isSkipNull){
        ...
        if(!isSkipNull || hasValue(from.getPassword()))
            to.setPassword(from.getPassword());
        if(!isSkipNull || hasValue(from.getId()))
            to.setId(from.getId());
        if(!isSkipNull || hasValue(from.getUserId()))
            to.setUserId(from.getUserId());
        if(!isSkipNull || hasValue(from.getName()))
            to.setName(from.getName());
        if(!isSkipNull || hasValue(from.getPhone()))
            to.setPhone(from.getPhone());
        if(!isSkipNull || hasValue(from.getEmail()))
            to.setEmail(from.getEmail());
        if(!isSkipNull || hasValue(from.getStatus()))
    ...
    public static void mapping(LoginHistory from, LoginHistoryDTO to, boolean isSkipNull){
        checkPermission(from, to);
        if(from ==null || to ==null) return;
        if(!isSkipNull || hasValue(from.getSeq()))
            to.setSeq(from.getSeq());
        if(!isSkipNull || hasValue(from.getUserId()))
            to.setUserId(from.getUserId());
        if(!isSkipNull || hasValue(from.getSuccessYN()))
            to.setSuccessYN(from.getSuccessYN());
        if(!isSkipNull || hasValue(from.getToken()))
            to.setToken(from.getToken());
        if(!isSkipNull || hasValue(from.getAgentInfo()))
            to.setAgentInfo(from.getAgentInfo());
        if(!isSkipNull || hasValue(from.getClientIp()))
            to.setClientIp(from.getClientIp());
        if(!isSkipNull || hasValue(from.getExpireDateTime()))
            to.setExpireDateTime(from.getExpireDateTime());
        if(!isSkipNull || hasValue(from.getCreateDateTime()))
    ...
    public static void mapping(ServiceInfo from, ServiceInfoDTO to, boolean isSkipNull){
        ...
        if(!isSkipNull || hasValue(from.getName()))
            to.setName(from.getName());
        if(!isSkipNull || hasValue(from.getKeyName()))
            to.setKeyName(from.getKeyName());
        if(!isSkipNull || hasValue(from.getMainUrl()))
            to.setMainUrl(from.getMainUrl());
        if(!isSkipNull || hasValue(from.getLoginUrl()))
    ...
    public static void mapping(MappingService from, MappingServiceDTO to, boolean isSkipNull){
        ...
        if(!isSkipNull || hasValue(from.getId()))
            to.setId(from.getId());
        if(!isSkipNull || hasValue(from.getRole()))
