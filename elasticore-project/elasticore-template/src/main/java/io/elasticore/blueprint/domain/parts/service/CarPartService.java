//ecd:-1151143723H20250425111000_V1.0
 ...
 * provided by CarPartCoreService.
 *
...
@Service
public class CarPartService extends CarPartCoreService {

    public CarPartService(PartsRepositoryHelper helper) {
        super(helper);
    }
